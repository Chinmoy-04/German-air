...
interface SmoothTabProps {
  ...
  /** Height of the sliding card area in pixels. Default: 200 */
  cardHeight?: number;
}
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="relative mb-4 flex-1">
        <div
          className="relative w-full rounded-2xl border bg-card"
      ...
      <div
        ...
        className={cn(
          ...
          "mx-auto w-full max-w-xl bg-background",
          "rounded-xl border",
          ...
          {items.map((item) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  "relative flex items-center justify-center gap-0.5 rounded-lg px-3 py-2",
